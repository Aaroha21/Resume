...
export const projects = [
  {
    ...
    demo: 'https://watches-store-main.vercel.app',
    featured: true,
  },
  {
    id: 2,
    ...
    category: 'Full Stack',
    description:
      'A full-stack personal finance tracker built for Indian users. Features include transaction management, budget tracking, receipt scanning, analytics dashboard with Recharts, and user authentication — all powered by Supabase and deployed on Vercel.',
    technologies: ['React', 'Vite', 'Supabase', 'Tailwind CSS', 'Recharts', 'Groq AI'],
    image: null,
    color: 'from-emerald-500 to-teal-600',
    github: 'https://github.com/Aaroha21/FinTrack',
    demo: '#',
    featured: true,
  },
];
